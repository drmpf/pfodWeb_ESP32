/*   
   pfodWeb_ESP32  basic framework for a pfodWeb / pfodApp server
   This sketch is an empty framework for displaying interactive and responsive GUIs via pfodWeb and pfodApp
   You need to add the dwg class files (generated by pfodWeb Designer or by hand) to this sketch
   It needs a extern mainDrawing defined to compile.
   It requires the following libraries pfodParser V3.63.5+
...
void setup(void) {
  ...
  ESP32_start_pfodWebServer(version,pfodWebServerURL);
